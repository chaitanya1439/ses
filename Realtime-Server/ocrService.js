...
export function setupOcrRoutes(app) {
    app.post('/api/ocr', upload.single('document'), async (req, res) => {
        try {
            ...
            let extractedData = { rawText: text };
            if (docType === 'pan') {
